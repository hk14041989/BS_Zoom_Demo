var testTool = {
    ...
    getMeetingConfig: function () {
        return {
            mn: parseInt(document.getElementById("meeting_id").value),
            name: testTool.b64EncodeUnicode(
                document.getElementById("display_name").value
            ),
            pwd: document.getElementById("meetting_password").value,
            role: 0,            
            signature: "",
        };
    },
    ...
    serialize: function (obj) {
        ...
        var keyOrderArr = ["name", "mn", "pwd", "role", "signature"];
